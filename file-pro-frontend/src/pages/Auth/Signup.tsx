    ...
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          >
            Auth Spec // Terminal Registration
          </div>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? "REGISTERING..." : "EXECUTE SIGNUP"}
          ...
          <p style={mono} className="text-center text-xs">
            <span style={{ color: `${INK}80` }}>ALREADY REGISTERED? </span>
            <Link
              to="/login"
              style={{ color: BLUE }}
        ...
        <div className="mt-8 text-center">
          <Link
            to="/"
            style={mono}
            className="text-xs uppercase tracking-wider text-sky-400 hover:underline"
          >
            ← RETURN_TO_LANDING
          </Link>
        </div>
