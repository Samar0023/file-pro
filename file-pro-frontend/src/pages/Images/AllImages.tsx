    ...
    >
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <p className="mt-3 text-base" style={{ color: `${INK}b3` }}>
          Manage, transform, and export uploaded bitmap assets.
        </p>
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-2" style={mono}>
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      style={{ borderColor: LINE }}
                      className="border bg-sky-500/10 py-2.5 text-center text-xs font-bold uppercase tracking-wider text-sky-400 transition hover:bg-sky-500/20"
                    >
                      Download
                    </a>
